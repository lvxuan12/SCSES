...
To detect splicing events You will need to install rMATS, MAJIQ, IRFinder. MAJIQ and rMATS should be built in the same environment with SCSES (same python).
