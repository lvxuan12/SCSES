...
Besides, [samtools](https://github.com/samtools/samtools) should be downloded.
...
2.  Softwares To detect splicing events You will need to install rMATS, MAJIQ, IRFinder. MAJIQ and rMATS should be built in the same environment with SCSES (same python).
...
[STAR](https://github.com/alexdobin/STAR) will be needed to build IRFinder reference
...
You can use `createConfigshiny` to generate configure file for your dataset.
