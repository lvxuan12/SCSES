---
title: "SCSES cell line Tutorial"
output:
...
In this tutorial, we will analyse scRNA-seq data of three cell line (HCT1954, HepG2, and HL-60). You can run this tutorial by downloading bam files at <https://doi.org/10.5281/zenodo.13943076>.
...
paras_file = "/disk/lvxuan/Single-Splicing/result/cell_line/scses_test/cell_line.json"
...
Imputed.data.path = Estimation(paras,rds_imputed_file="/disk/lvxuan/Single-Splicing/result/cell_line/scses_test/imputation/Imputed_seperated_499999153.rds")
```
