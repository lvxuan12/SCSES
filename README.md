...
- [SCSES](#scses)
  ...
  - [SCSES input](#scses-input)
    ...
    - [3. Configuration File](#3-configuration-file)
      - [3.1. Set the host to the server’s IP
        address](#31-set-the-host-to-the-servers-ip-address)
      - [3.2. Set launch.browser = FALSE to avoid browser launch
        errors](#32-set-launchbrowser--false-to-avoid-browser-launch-errors)
      - [3.3. Manually access the application URL shown in the
        console](#33-manually-access-the-application-url-shown-in-the-console)
