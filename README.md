...
- [SCSES](#scses)
  ...
  - [Getting started](#getting-started)
    ...
    - [Running SCSES on UMI-based scRNA-seq
      data](#running-scses-on-umi-based-scrna-seq-data)
...
We recommend conda to install the package:
...
### Running SCSES on UMI-based scRNA-seq data
